...
FROM (
    ...
    WHERE t.CodigoSerie = :Serie 
      AND t.CodigoNumero = :Numero 
      AND t.CodigoPerfil = :CodigoArticulo
      AND t.CodigoAcabado = :CodigoAcabado 
      AND ((t.CodigoAcabado2 = :CodigoAcabado2) OR ((t.CodigoAcabado2 IS NULL) AND (:CodigoAcabado2 = '')))

-- Consulta que replica la lógica de sp_fpresupuestosoptimizacion_exacto
-- Devuelve las columnas en el formato solicitado


-- Consulta con lógica completa de agrupación y optimización de barras
SELECT
    CodigoNumero,
    CodigoPerfil,
    CodigoAcabado,
...
FROM (
    ...
    FROM (
        SELECT CodigoNumero, CodigoPerfil, CodigoAcabado, CodigoAcabado2, Ancho, Maquina, Tipo,
            Med, MedH, Modulo, CASILLERO, CASILLEROB, Corte1, Corte2, Corte1b, Corte2b,
            ID, KTN, MAQ, MAQ2, REF, Lin, Sit, Rec, UD, Grafico, Parametros
        FROM (
            -- Descomposición de ítems individuales
            SELECT CodigoNumero, CodigoPerfil, CodigoAcabado, CodigoAcabado2, Ancho, Maquina, Tipo,
                Med0 AS Med, MedH0 AS MedH, Modulo0 AS Modulo, CASILLERO0 AS CASILLERO, CASILLEROB0 AS CASILLEROB,
                ...
                Lin0 AS Lin, Sit0 AS Sit, Rec0 AS Rec, UD0 AS UD, Grafico, Parametros
...
AND CodigoAcabado = :CodigoAcabado AND 
  ((CodigoAcabado2 = :CodigoAcabado2) OR ((CodigoAcabado2 is null) AND (:CodigoAcabado2 = '')))
            ...
            UNION ALL
            SELECT CodigoNumero, CodigoPerfil, CodigoAcabado, CodigoAcabado2, Ancho, Maquina, Tipo,
                Med1 AS Med, MedH1 AS MedH, Modulo1 AS Modulo, CASILLERO1 AS CASILLERO, CASILLEROB1 AS CASILLEROB,
                ...
                Lin1 AS Lin, Sit1 AS Sit, Rec1 AS Rec, UD1 AS UD, Grafico, Parametros
                        FROM fpresupuestosoptimizacion
                        WHERE CodigoSerie = :Serie AND CodigoNumero = :Numero AND CodigoPerfil = :CodigoArticulo
AND CodigoAcabado = :CodigoAcabado AND 
  ((CodigoAcabado2 = :CodigoAcabado2) OR ((CodigoAcabado2 is null) AND (:CodigoAcabado2 = '')))
            ...
            UNION ALL
            SELECT CodigoNumero, CodigoPerfil, CodigoAcabado, CodigoAcabado2, Ancho, Maquina, Tipo,
                Med2 AS Med, MedH2 AS MedH, Modulo2 AS Modulo, CASILLERO2 AS CASILLERO, CASILLEROB2 AS CASILLEROB,
                ...
                Lin2 AS Lin, Sit2 AS Sit, Rec2 AS Rec, UD2 AS UD, Grafico, Parametros
                        FROM fpresupuestosoptimizacion
                        WHERE CodigoSerie = :Serie AND CodigoNumero = :Numero AND CodigoPerfil = :CodigoArticulo
AND CodigoAcabado = :CodigoAcabado AND 
  ((CodigoAcabado2 = :CodigoAcabado2) OR ((CodigoAcabado2 is null) AND (:CodigoAcabado2 = '')))
            ...
            UNION ALL
            SELECT CodigoNumero, CodigoPerfil, CodigoAcabado, CodigoAcabado2, Ancho, Maquina, Tipo,
                Med3 AS Med, MedH3 AS MedH, Modulo3 AS Modulo, CASILLERO3 AS CASILLERO, CASILLEROB3 AS CASILLEROB,
                ...
                Lin3 AS Lin, Sit3 AS Sit, Rec3 AS Rec, UD3 AS UD, Grafico, Parametros
                        FROM fpresupuestosoptimizacion
                        WHERE CodigoSerie = :Serie AND CodigoNumero = :Numero AND CodigoPerfil = :CodigoArticulo
AND CodigoAcabado = :CodigoAcabado AND 
  ((CodigoAcabado2 = :CodigoAcabado2) OR ((CodigoAcabado2 is null) AND (:CodigoAcabado2 = '')))
            ...
            UNION ALL
            SELECT CodigoNumero, CodigoPerfil, CodigoAcabado, CodigoAcabado2, Ancho, Maquina, Tipo,
                Med4 AS Med, MedH4 AS MedH, Modulo4 AS Modulo, CASILLERO4 AS CASILLERO, CASILLEROB4 AS CASILLEROB,
                ...
                Lin4 AS Lin, Sit4 AS Sit, Rec4 AS Rec, UD4 AS UD, Grafico, Parametros
                        FROM fpresupuestosoptimizacion
                        WHERE CodigoSerie = :Serie AND CodigoNumero = :Numero AND CodigoPerfil = :CodigoArticulo
AND CodigoAcabado = :CodigoAcabado AND 
  ((CodigoAcabado2 = :CodigoAcabado2) OR ((CodigoAcabado2 is null) AND (:CodigoAcabado2 = '')))
            ...
            UNION ALL
            SELECT CodigoNumero, CodigoPerfil, CodigoAcabado, CodigoAcabado2, Ancho, Maquina, Tipo,
                Med5 AS Med, MedH5 AS MedH, Modulo5 AS Modulo, CASILLERO5 AS CASILLERO, CASILLEROB5 AS CASILLEROB,
                ...
                Lin5 AS Lin, Sit5 AS Sit, Rec5 AS Rec, UD5 AS UD, Grafico, Parametros
                        FROM fpresupuestosoptimizacion
                        WHERE CodigoSerie = :Serie AND CodigoNumero = :Numero AND CodigoPerfil = :CodigoArticulo
AND CodigoAcabado = :CodigoAcabado AND 
  ((CodigoAcabado2 = :CodigoAcabado2) OR ((CodigoAcabado2 is null) AND (:CodigoAcabado2 = '')))
            ...
            UNION ALL
            SELECT CodigoNumero, CodigoPerfil, CodigoAcabado, CodigoAcabado2, Ancho, Maquina, Tipo,
                Med6 AS Med, MedH6 AS MedH, Modulo6 AS Modulo, CASILLERO6 AS CASILLERO, CASILLEROB6 AS CASILLEROB,
                ...
                Lin6 AS Lin, Sit6 AS Sit, Rec6 AS Rec, UD6 AS UD, Grafico, Parametros
                        FROM fpresupuestosoptimizacion
                        WHERE CodigoSerie = :Serie AND CodigoNumero = :Numero AND CodigoPerfil = :CodigoArticulo
AND CodigoAcabado = :CodigoAcabado AND 
  ((CodigoAcabado2 = :CodigoAcabado2) OR ((CodigoAcabado2 is null) AND (:CodigoAcabado2 = '')))
            ...
            UNION ALL
            SELECT CodigoNumero, CodigoPerfil, CodigoAcabado, CodigoAcabado2, Ancho, Maquina, Tipo,
                Med7 AS Med, MedH7 AS MedH, Modulo7 AS Modulo, CASILLERO7 AS CASILLERO, CASILLEROB7 AS CASILLEROB,
                ...
                Lin7 AS Lin, Sit7 AS Sit, Rec7 AS Rec, UD7 AS UD, Grafico, Parametros
                        FROM fpresupuestosoptimizacion
                        WHERE CodigoSerie = :Serie AND CodigoNumero = :Numero AND CodigoPerfil = :CodigoArticulo
AND CodigoAcabado = :CodigoAcabado AND 
  ((CodigoAcabado2 = :CodigoAcabado2) OR ((CodigoAcabado2 is null) AND (:CodigoAcabado2 = '')))
            ...
            UNION ALL
            SELECT CodigoNumero, CodigoPerfil, CodigoAcabado, CodigoAcabado2, Ancho, Maquina, Tipo,
                Med8 AS Med, MedH8 AS MedH, Modulo8 AS Modulo, CASILLERO8 AS CASILLERO, CASILLEROB8 AS CASILLEROB,
                ...
                Lin8 AS Lin, Sit8 AS Sit, Rec8 AS Rec, UD8 AS UD, Grafico, Parametros
                        FROM fpresupuestosoptimizacion
                        WHERE CodigoSerie = :Serie AND CodigoNumero = :Numero AND CodigoPerfil = :CodigoArticulo
AND CodigoAcabado = :CodigoAcabado AND 
  ((CodigoAcabado2 = :CodigoAcabado2) OR ((CodigoAcabado2 is null) AND (:CodigoAcabado2 = '')))
            ...
            UNION ALL
            SELECT CodigoNumero, CodigoPerfil, CodigoAcabado, CodigoAcabado2, Ancho, Maquina, Tipo,
                Med9 AS Med, MedH9 AS MedH, Modulo9 AS Modulo, CASILLERO9 AS CASILLERO, CASILLEROB9 AS CASILLEROB,
                ...
                Lin9 AS Lin, Sit9 AS Sit, Rec9 AS Rec, UD9 AS UD, Grafico, Parametros
                        FROM fpresupuestosoptimizacion
                        WHERE CodigoSerie = :Serie AND CodigoNumero = :Numero AND CodigoPerfil = :CodigoArticulo
AND CodigoAcabado = :CodigoAcabado AND 
  ((CodigoAcabado2 = :CodigoAcabado2) OR ((CodigoAcabado2 is null) AND (:CodigoAcabado2 = '')))
    ...
    CROSS JOIN (SELECT @barra_actual := 1, @longitud_acumulada := 0, @items_en_barra := 0, @barra_anterior := 1) AS vars
    ORDER BY Med DESC, Modulo
) items_optimizados
WHERE Barra IS NOT NULL
GROUP BY CodigoNumero, CodigoPerfil, CodigoAcabado, CodigoAcabado2, Barra
ORDER BY CodigoPerfil, CodigoAcabado, CodigoAcabado2, Barra;

...
-- EL SIGUIENTE CALL NO LO TOMES EN CUENTA, ES SOLO PARA SABER QUE STORE PROCEDURE LLAMA
-- CALL sp_fpresupuestosoptimizacion_exacto(:Serie, :Numero, :CodigoArticulo, :CodigoAcabado, :CodigoAcabado2);
-- =====================================================================
